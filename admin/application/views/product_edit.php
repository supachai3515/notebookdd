<div id="page-wrapper" ng-app="myApp">
    <div class="container-fluid" ng-controller="myCtrl">
		...
		<div class="form-group">
		  ...
		  <div class="checkbox">
		    <label for="is_reservations-0">
		      ...
		      <?php if ($product_data['is_reservations']==1): ?>
		      	<?php echo "checked"; ?>
		      <?php endif ?>
		      >
		      สามารถจองได้
		...
		<!-- Multiple Checkboxes -->
		<div class="form-group">
		  <label class="col-md-3 control-label" for="is_add_outofstock">สั่งซื้อได้เมื่อสินค้าหมด</label>
		  <div class="col-md-4">
		  <div class="checkbox">
		    <label for="is_add_outofstock-0">
		      <input type="checkbox" name="is_add_outofstock" id="is_add_outofstock-0" value="1" 
		      <?php if ($product_data['is_add_outofstock']==1): ?>
		      	<?php echo "checked"; ?>
		      <?php endif ?>
		      >
		      สามารถสั่งซื้อได้เมื่อสินค้าหมด
		    </label>
			</div>
		  </div>
		</div>
