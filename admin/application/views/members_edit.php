<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid box" ng-controller="mainCtrl">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url('members/update/'.$member_data['id']);?>" accept-charset="utf-8"
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="id" name="id" type="text" disabled="true" value="<?php echo $member_data['id']; ?>" placeholder="รหัส" class="form-control input-md"
                                required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="first_name" name="first_name" type="text" value="<?php echo $member_data['first_name']; ?>" placeholder="ชื่อ"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="tax_number" name="tax_number" type="text" value="<?php echo $member_data['tax_number']; ?>" placeholder="เลขประจำตัวผู้เสียภาษี"
                    ...
                    <!-- Multiple Checkboxes -->
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="verify">ยืนยัน</label>
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label for="verify-0">
                                    <input type="checkbox" name="verify" id="verify-0" value="1" <?php if ($member_data[ 'verify']==1): ?>
                                    <?php echo "checked"; ?>
                                    <?php endif ?> > ยืนยันแล้ว
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label for="isactive-0">
                                    <input type="checkbox" name="isactive" id="isactive-0" value="1" <?php if ($member_data[ 'is_active']==1): ?>
                                    <?php echo "checked"; ?>
                                    <?php endif ?> > ใช้งาน
                                </label>
                            </div>
