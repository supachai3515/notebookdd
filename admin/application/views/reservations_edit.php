          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
             ...
             <form action="<?php echo base_url('reservations/update_reservations/'.$reservations_data['id']); ?>" method="POST" class="form-inline" role="form">
              <div class="form-group">
                <label class="wating_date" for="">กำหนดวันที่รับสินค้า</label>
                <input type="number" class="form-control" id="wating_date" name="wating_date"  style="width:100px;"
                <?php if (isset($order_reservations['wating_date'])): ?>
               ...
               <div class="form-group">
                <label for="price_set">ราคาสินค้า</label>
                <input type="number" class="form-control" id="price_set" name="price_set" style="width:100px;"
                 <?php if (isset($order_reservations['price_set'])): ?>
                  value="<?php echo $order_reservations['price_set']; ?>"
                <?php endif ?>
                 placeholder="ราคา">
              </div>
            ...
            <form action="<?php echo base_url('reservations/sandmail_reservations/'.$reservations_data['id']); ?>" method="POST" class="form-inline" role="form">
              <button type="submit" class="btn btn-info">ส่ง email</button> 
              <?php if ($reservations_data['is_sendmail']): ?>
                <span class="text-success">ส่งเมลล์แล้ว</span>
              <?php else: ?>
                <span class="text-warning">ยังไม่ได้ส่งเมล์</span>
              <?php endif ?>
            </form>
