                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    <?php echo $member['address_receipt']; ?>
                                </span>

                            </td>
                            <td>
                                <span>
                                    <?php echo $member['address_tax']; ?>
                                </span>
                            </td>
                            <td>
                                <span>
                            ...
                            <td>
                                <span>
                                    ...
                                    <?php echo date("d-m-Y H:i", strtotime($member['date']));?>
                                </span>
                                <br/>
                                <?php if ($member['is_active']=="1"): ?>
                                <span>
                                    <i class="fa fa-check"></i> ใช้งาน</span>
                                <br/>
                                <?php else: ?>
                                <span class="text-danger">
                                    <i class="fa fa-times"></i> ยกเลิก</span>
                                <br/>
                                <?php endif ?>
                            </td>
                            <td>
                                <a class="btn btn-xs btn-info" href="<?php echo base_url('members/edit/'.$member['id']) ?>" role="button">
