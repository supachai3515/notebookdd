<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid box" ng-controller="mainCtrl">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url('documents/update/'.$document_data['id']);?>" accept-charset="utf-8"
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="id" name="id" type="text" disabled="true" value="<?php echo $document_data['id']; ?>" placeholder="รหัส" class="form-control input-md"
                                required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="name" name="name" type="text" value="<?php echo $document_data['name']; ?>" placeholder="ชื่อ" class="form-control input-md"
                                required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="description" name="description" type="text" value="<?php echo $document_data['description']; ?>" placeholder="description"
                        ...
                        <div class="col-md-4">
                            <div class="checkbox">
                                <label for="isactive-0">
                                    <input type="checkbox" name="isactive" id="isactive-0" value="1" <?php if ($document_data[ 'is_active']==1): ?>
                                    <?php echo "checked"; ?>
                                    <?php endif ?> >
                                </label>
                            </div>
