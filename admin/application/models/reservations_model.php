...
class Reservations_model extends CI_Model {
	...
	public function update_status_new($reservations_id)
	{
	...
	public function update_reservations_date($reservations_id)
	{
		...
		if ( $this->input->post('price_set') > 0) {
			...
			$where = "id = '".$reservations_id."'"; 
			$this->db->update("orders", $order_, $where);
			...
			$where = "order_id = '".$reservations_id."'"; 
			$this->db->update("order_detail", $order_detail, $where);
