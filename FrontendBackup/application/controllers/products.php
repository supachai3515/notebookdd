...
class Products extends CI_Controller {
	...
	public function index($page=0)
	{
		...
		$config['first_tagl_close'] = "</li>";
		$config['last_tag_open'] = "<li>";
		$config['last_link'] = 'Last <i class="fa fa-angle-right"></i>';
		$config['last_tagl_close'] = "</li>";
	...
	public function category_brand($type, $brand, $page=0)
	{
		...
		$data['title_tag'] ='หมวดสินค้า : '.$type.' , ยี่ห้อสินค้า : '.$brand;
	...
	public function category($type,$page=0)
	{
		...
		$data['title_tag'] ='หมวดสินค้า : '.$type.'';
	...
	public function brand($brand,$page=0)
	{
		...
		$data['title_tag'] ='ยี่ห้อสินค้า : '.$brand.'';
