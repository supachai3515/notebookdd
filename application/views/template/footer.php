            ...
            <div class="row">
                        ...
                        <div class="footer-logo">
                            <div class="logo">
                                <a href="<?php echo base_url();?>">
                                    <img src="<?php echo base_url('theme_unicase');?>/assets/images/NBDD_LOGO.jpg" alt="" style="max-width: 181px;">
                                </a>
                            </div><!-- /.logo -->
                        </div><!-- /.footer-logo -->
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="contact-timing">
                        <div class="module-heading">
                            <h4 class="module-title">เวลาทำการ</h4>
                        </div><!-- /.module-heading -->
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="latest-tweet">
                        <div class="module-heading">
                            <h4 class="module-title">ช่องทางการชำระเงิน</h4>
                        </div><!-- /.module-heading -->
                                ...
                                <div class="comment media">
                                    <div class="media-body">
                                        <a href="<?php echo base_url('payment');?>/">
                                            <img src="<?php echo base_url('theme_unicase')?>/assets/images/bankimg.jpg" alt="" style="max-width: 181px;">
                                        </a>
                                    </div>
                                </div>
    ...
    <div class="footer-bottom inner-bottom-sm">
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="module-heading outer-bottom-xs">
                        <h4 class="module-title">บัญชีผู้ใช้</h4>
                    </div><!-- /.module-heading -->
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="module-heading outer-bottom-xs">
                        <h4 class="module-title">ความช่วยเหลือ</h4>
                    </div><!-- /.module-heading -->
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li>
