    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>เงื่อนไขการรับประกัน</li>
            </ul>
            ...
            <div class="row">
                <div class="col-md-12 terms-conditions">
                    ...
                    <div class="inner-top-sm">
                        <h3>สินค้านอกเงื่อนไขการรับประกัน</h3>
                        <ol>
                        ...
                        <h3>วิธีการส่งสินค้ามาเคลมหรือเปลี่ยนสินค้า</h3>
                        <ol>
                        ...
                        <h3>ติดต่อเรา</h3>
                        <p>หากมีข้อสงสัยเกี่ยวกับเงื่อนไขการรับประกัน กรุณา <a href="#" class='contact-form'>ติดต่อเรา</a></p>
                    </div>
                </div>
            </div><!-- /.row -->
        </div><!-- /.sigin-in-->
